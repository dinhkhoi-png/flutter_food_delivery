      ...
      children: [
              ...
              child: Row(
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: SmallText(text: "Menu",color: Colors.grey,),
                  ),
        ...
        ListView.builder(
            ...
            itemBuilder: (context , index){
              return Container(
                margin: EdgeInsets.only(left: Dimensions.width20,bottom: Dimensions.height10,right: Dimensions.width5),
                child: Row(
                  children: [
                    //image redcommended
                    Container(
                      ...
                      child: Container(
                        ...
                        child: Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              BigText(text: "Mon an chinese best saler qua ngon"),
                              ...
                              Row(
                                ...
                                children: [
                                  ...
                                  IconAndTextWidget(
                                      icon: Icons.location_on, text: "1.7km", iconColor: AppColors.iconColor1
                                  ),
                                  IconAndTextWidget(
                                      icon: Icons.access_time_filled_rounded, text: "32min", iconColor: AppColors.iconColor2
                                  ),
                                ],
                              )
                            ],
